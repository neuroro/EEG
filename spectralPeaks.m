...
%
%   method:        Peak or sink finding method
...
%
%   frequencyBand: Frequency band or frequency limits to find exrema within
%                    'Delta'     1 to <4 Hz
%                    'Theta'     4 to <8 Hz
%                    'Theta+'  2.5 to 8.5 Hz
%                    'ThetaGL'   2 to 10 Hz
...
%                    'Beta'     13 to 30 Hz
%                    'Gamma'   >30 to 80 Hz
%                    [f1 f2]   frequency limits f1 to f2 Hz
%                    (optional input: default Theta+ 2.5-8.5 Hz)
%
%   timeLimit:     Time limit or limits (in ms) within which to find peaks
%                    or sinks, as below:
%                    maximum time for stimulus-related spectra t2
%                      other time limits are dervied in proportion to t2
%                    vector of stimulus-related time limits [t1 t2]
%                      other time limits are dervied in proportion to t2
...
%
%   peakSize:      Peak or sink mean magnitude neighbourhood size in 
%                    frequencies (in Hz) and times (in ms) on either side 
%                    of the peak as [f t]
...
thetaWide = { 'ThetaExtended' 'ThetaWide' 'ThetaPlus' 'Theta+' 'Tx' 'Tw' 'T+' };
thetaExt  = [ 2.5 8.5 ];
